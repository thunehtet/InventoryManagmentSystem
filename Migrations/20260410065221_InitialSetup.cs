            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FullName = table.Column<string>(type: "varchar(200)", maxLength: 200, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    IsTenantAdmin = table.Column<bool>(type: "tinyint(1)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SecondaryColor = table.Column<string>(type: "varchar(20)", maxLength: 20, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ShowFinanceModule = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    ShowInventoryModule = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    ShowSalesModule = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    ShowReportsModule = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    InvoicePrefix = table.Column<string>(type: "varchar(20)", maxLength: 20, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    OrderPrefix = table.Column<string>(type: "varchar(20)", maxLength: 20, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
